...
def generate_launch_description():
    ...
    #Ruta para archivo urdf del robot
    urdfModelPath= os.path.join(pkgPath, 'urdf/dofbot_arm.urdf') #Concatena las cadenas separadas por coma y valida las diagonales

    #Leemos el contenido del archivo r es de read
