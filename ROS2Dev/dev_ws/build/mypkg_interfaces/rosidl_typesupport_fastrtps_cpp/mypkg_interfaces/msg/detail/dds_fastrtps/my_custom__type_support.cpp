...
#include "mypkg_interfaces/msg/detail/my_custom__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypkg_interfaces::msg::MyCustom;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mypkg_interfaces::msg::MyCustom *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mypkg_interfaces::msg::MyCustom *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MyCustom__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mypkg_interfaces::msg::MyCustom *>(
...
static size_t _MyCustom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MyCustom(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MyCustom__callbacks = {
...
static rosidl_message_type_support_t _MyCustom__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MyCustom__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mypkg_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mypkg_interfaces::msg::MyCustom>()
{
  return &mypkg_interfaces::msg::typesupport_fastrtps_cpp::_MyCustom__handle;
}
